...
public class Index : PageModel
{
	...
	public async Task<IActionResult> OnPost()
	{
		...
		if (ModelState.IsValid)
		{
			try
			{
				// "built in" guard, which will throw exception if the input is not an email
				_ = new MailAddress(Input.Username);
			...
			ModelState.AddModelError("", LoginOptions.InvalidCredentialsErrorMessage);
		}
	...
	private async Task BuildModelAsync(string returnUrl)
	{
		...
		{
			var local =
				context.IdP == LocalIdentityProvider;
